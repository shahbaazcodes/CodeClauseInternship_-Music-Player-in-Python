...
class Player(tk.Frame):
	...
	def track_widgets(self):
		...
		self.songtrack['text'] = 'Shahbaaz\'s MP3 player'
...
img = load_image("music-player.png")
next_ = load_image("play.png")  # Placeholder for skip_next
prev = load_image("rewind.png")
